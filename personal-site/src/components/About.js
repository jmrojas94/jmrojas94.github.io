  ...
  render() {
    return (
    	<div id="about" className="about-section">
          ...
          <div className="row">
            <div id="about-title" className="about-title col-md-6 col-sm-12">
              <div className="text-center content-header">
                <h2>ABOUT ME</h2>
              </div>
            </div>
            <div className="about-me col-md-6 col-sm-12">
              <div className="hex">
                <div className="hex2">
              ...
              <div className="about-content">
                  ...
                  <p>
                      I grew up in a small town in South West Texas, where boredom led me towards honing creative skills in music and art. Eager to pursue a career where creativity was at the forefront, I started learning graphic design, photography, and guitar. I played in a mildly successful local band which taught me networking skills, as well as management and marketing.
                  </p>
                  <p>
